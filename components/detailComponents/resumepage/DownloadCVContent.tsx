...
const DownloadCVContent = () => {
  ...
  return (
    <>
      <div className="relative p-0.5 overflow-hidden max-sm:mx-8 rounded-xl group max-w-xl mx-auto my-15 select-none shadow-[0_0_30px_rgba(59,130,246,0.4)]">
        ...
        >
          <a href={"EmilKazimovCV.pdf"} download={"Portfolio-EmilKazimovCV.pdf"} className="text-white font-bold text-lg tracking-wide flex items-center justify-center gap-2">
            <span className="drop-shadow-[0_0_8px_rgba(59,130,246,0.8)] max-md:text-[30px] max-sm:text-[18px]">
              Download CV
            </span>
          </a>
        </button>
